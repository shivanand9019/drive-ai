...
function StatusBadge({ status }) {
  if (status === 'Ready') {
    return <Badge color="green" dot>Ready</Badge>;
  }

  if (status === 'Processing') {
    return <Badge color="amber" dot>Processing</Badge>;
  }
...
export default function FileTable({
    ...
    return (
        <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          {Array.from({ length: 5 }).map((_, i) => (
              ...
              <div
                  key={i}
                  className="flex items-center gap-4 px-5 py-4 border-b border-slate-100 dark:border-slate-800 last:border-0 shimmer"
              >
  ...
  /*
   * Select actions based on whether this
   * is the Trash page.
   */
  const actions = trash
      ? TRASH_ACTIONS
      ...
      <tr className="border-b border-slate-100 dark:border-slate-800 last:border-0 hover:bg-slate-50/60 dark:hover:bg-slate-800/20 transition-colors group">
        ...
        <td className="px-5 py-3.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div
                className={`h-9 w-9 rounded-lg ${meta.bg} grid place-items-center shrink-0`}
            >
              <FileIcon
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-medium text-slate-800 dark:text-slate-100 truncate max-w-[220px]">
        ...
        <td className="px-5 py-3.5 text-right">
          ...
          >
            ...
            {open && (
                ...
                <div className="absolute right-0 mt-1 w-48 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-card p-1.5 z-20 animate-scale-in origin-top-right">
  ...
  return (
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div
              className={`h-10 w-10 rounded-lg ${meta.bg} grid place-items-center shrink-0`}
          >
            <FileIcon
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400">
              {meta.label} · {formatBytes(file.fileSize)} · {formatDate(file.uploadedAt)}
            </p>
